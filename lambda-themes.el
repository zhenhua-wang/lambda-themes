...
;;;;; Org mode
     ...
     `(org-document-info-keyword                    ((,class (:inherit ,(if lambda-themes-set-variable-pitch 'variable-pitch 'default) :height 1.15 (:foreground ,lambda-meek :weight light)))))
     ...
     `(org-meta-line                                ((,class (:inherit ,(if lambda-themes-set-variable-pitch 'variable-pitch 'default) :height 1.1 :foreground ,lambda-meek :weight light))))
