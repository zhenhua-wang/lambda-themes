...
(defun lambda-themes-create (variant theme-name)
  ...
  (let ((class '((class color) (min-colors 89))) ;;          ~~Dark~~                                                               ~~Light~~
        ...
        (lambda-green       (cond ((eq variant 'dark)  "#62C554") ((eq variant 'dark-faded) "#8eb89d") ((eq variant 'light) "#61C554") ((eq variant 'light-faded) "#00796b")))
        ...
        (lambda-yellow      (cond ((eq variant 'dark)  "#F4BF4F") ((eq variant 'dark-faded) "#e9b85d") ((eq variant 'light) "#F4BF4F") ((eq variant 'light-faded) "#e0a500")))
...
;;;;;; Dired Colors (Diredfl)
     ...
     `(diredfl-dir-heading                           ((,class (:inherit ,(if lambda-themes-set-variable-pitch 'variable-pitch 'default) :foreground ,lambda-blue :background ,lambda-faint))))
...
;;;;; Org-agenda
     ...
     `(org-agenda-date-today                        ((,class (:inherit ,(if lambda-themes-set-variable-pitch 'variable-pitch 'default) :foreground ,lambda-blue))))
     `(org-super-agenda-header                      ((,class (:inherit ,(if lambda-themes-set-variable-pitch 'variable-pitch 'default) :foreground ,lambda-blue))))
...
;;;;; Org mode
     ...
     `(org-document-title                           ((,class ((when lambda-themes-set-variable-pitch :inherit variable-pitch) :height 1.1 :foreground ,lambda-focus))))
