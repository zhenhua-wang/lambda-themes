...
;;;;; Default
     ...
     `(region               ((,class (:background ,lambda-ultralight))))
...
;;;;;; Magit
     ...
     `(magit-section-heading       ((,class (:foreground ,lambda-meek :inherit variable-pitch))))
...
;;;;;; Dired Colors (Diredfl)
     ...
     `(diredfl-ignored-file-name                     ((,class (:foreground ,lambda-mild))))
     ...
     `(diredfl-file-suffix                           ((,class (:foreground ,lambda-ultralight))))
     ...
     `(diredfl-dir-name                              ((,class (:foreground ,lambda-meek))))
     `(diredfl-dir-heading                           ((,class (:inherit variable-pitch :foreground ,lambda-blue :background ,lambda-faint))))
...
;;;;;; Help(ful)
     `(helpful-heading ((,class (:inherit variable-pitch :foreground ,lambda-blue))))
...
;;;;;; Outline
     ...
     `(outline-1            ((,class (:inherit variable-pitch :foreground ,lambda-fg))))
     `(outline-2            ((,class (:inherit variable-pitch :foreground ,lambda-meek))))
     `(outline-3            ((,class (:inherit variable-pitch :foreground ,lambda-fg))))
     `(outline-4            ((,class (:inherit variable-pitch :foreground ,lambda-meek))))
...
;;;;; Org-agenda
     ...
     `(org-agenda-date-today                        ((,class (:inherit variable-pitch :foreground ,lambda-blue))))
     `(org-super-agenda-header                      ((,class (:inherit variable-pitch :foreground ,lambda-blue))))
...
;;;;; Org mode
     ...
     `(org-cite                                     ((,class (:foreground ,lambda-focus))))
     ...
     `(org-document-title                           ((,class (:inherit variable-pitch :height 1.1 :foreground ,lambda-focus))))
...
;;;;;; Lambda-line
     ...
     (when (and (fboundp 'lambda-line)
       ...
       `(header-line ((,class (:foreground ,lambda-fg :background ,lambda-faint
     ...
     `(lambda-line-active               ((,class (:foreground ,lambda-fg   :box (:line-width 1 :color ,lambda-highlight :style nil)))))
     `(lambda-line-inactive             ((,class (:foreground ,lambda-meek :box (:line-width 1 :color ,lambda-highlight :style nil)))))
     ...
     `(lambda-line-active-status-RW     ((,class (:foreground ,lambda-green  :box (:line-width 1 :color ,lambda-highlight :style nil)))))
     `(lambda-line-inactive-status-RW   ((,class (:foreground ,lambda-meek   :box (:line-width 1 :color ,lambda-highlight :style nil)))))
     `(lambda-line-active-status-**     ((,class (:foreground ,lambda-red    :box (:line-width 1 :color ,lambda-highlight :style nil)))))
     `(lambda-line-inactive-status-**   ((,class (:foreground ,lambda-meek   :box (:line-width 1 :color ,lambda-highlight :style nil)))))
     `(lambda-line-active-status-RO     ((,class (:foreground ,lambda-yellow :box (:line-width 1 :color ,lambda-highlight :style nil)))))
     `(lambda-line-inactive-status-RO   ((,class (:foreground ,lambda-meek   :box (:line-width 1 :color ,lambda-highlight :style nil)))))
