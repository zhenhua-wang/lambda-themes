...
(defun lambda-themes-create (variant theme-name)
  ...
  (let ((class '((class color) (min-colors 89))) ;;     ~~Dark~~                                                            ~~Light~~
        ...
        ;; highlighting
        (lambda-ultralight  (cond ((eq variant 'dark)  "#2c2c34") ((eq variant 'dark-faded) "#525868") ((eq variant 'light) "#F8F6F4") ((eq variant 'light-faded) "#e3e7ef")))
        ...
        (lambda-lowlight    (cond ((eq variant 'dark)  "#1A1919") ((eq variant 'dark-faded) "#3c4353") ((eq variant 'light) "#EBE9E7") ((eq variant 'light-faded) "#cfd6e2")))
        ;; attention
...
;;;;;; Tab-bar
     ...
     `(tab-line-tab-current       ((,class (:background ,lambda-ultralight :foreground ,lambda-fg))))
     `(tab-line-tab-inactive      ((,class (:background ,lambda-lowlight :foreground ,lambda-meek))))
     `(tab-line-tab               ((,class (:background ,lambda-lowlight :foreground ,lambda-meek))))
     `(tab-line-tab-modified      ((,class (:background ,lambda-ultralight :foreground ,lambda-yellow))))
